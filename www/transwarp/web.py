...
class Request(object):
    ...
    def input(self, **kw):
        ...
        for k, v in raw.iteritems():
            copy[k] = v[0] if isinstance(v, list) else vars
        return copy
...
class WSGIApplication(object):
    ...
    def _check_not_running(self):
        if self._running:
            raise RuntimeError('Connot modify WSGIApplication when running.')
